...
const servicesData = [
  {
    ...
    subtitle:
      "Cinematic, heartfelt films that capture the authentic emotion and unique story of your special day.",
    handle: "Learn More",
  ...
  },
  {
    ...
    subtitle:
      "Engaging, short-form video content optimized for platforms like Instagram, TikTok, and Facebook.",
    handle: "Learn More",
  ...
  },
  {
    ...
    subtitle:
      "Professional, high-impact commercials and promotional videos designed to elevate your brand or business.",
    handle: "Learn More",
          ...
          >
            <div className="service-content">
              ...
              <div className="service-info">
                ...
                <a href={service.url} className="service-handle">
                  {service.handle}
                </a>
              </div>
            </div>
